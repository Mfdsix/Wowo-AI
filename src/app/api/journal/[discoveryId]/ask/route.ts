...
import { askDiscovery, recordEvent } from "@/lib/journal";
import { getCodeFromCookies, SUPER_ADMIN_CODE } from "@/lib/auth";

export const dynamic = "force-dynamic";

// ─── Journal Engine: Contextual Ask (PRD §10) ────────────────
// POST /api/journal/:discoveryId/ask
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json({ error: `Journal ask error: ${msg}` }, { status: 502 });
  }
}
